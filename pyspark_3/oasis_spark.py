...
def main():
    # SUBMIT_ARGS = '--packages com.arangodb:arangodb-spark-datasource-3.1_2.12:0.2.0-SNAPSHOT --repositories="https://oss.sonatype.org/content/repositories/snapshots"'
